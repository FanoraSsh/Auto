...
# DNS PATCH
#tipeos2=$(uname -m)
#Name=$(curl -sS https://raw.githubusercontent.com/FanoraSsh/anjim/main/anjay/allow | grep $MYIP | awk '{print $2}')
#Exp=$(curl -sS https://raw.githubusercontent.com/FanoraSsh/anjim/main/anjay/allow | grep $MYIP | awk '{print $3}')
# GETTING DOMAIN NAME
